...
namespace Docimax.Data_ICD
{
    ...
    public partial class Entities_Read : DbContext
    {
        public Entities_Read()
            : base("name=Entities_Read")
        {
        }
        ...
        public virtual DbSet<Dic_ICD_Repository> Dic_ICD_Repository { get; set; }
        public virtual DbSet<Dic_ICD_Version> Dic_ICD_Version { get; set; }
